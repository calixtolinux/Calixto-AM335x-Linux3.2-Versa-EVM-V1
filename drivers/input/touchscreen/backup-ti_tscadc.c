...
#define TSCADC_CNTRLREG_HWPREEMPT		BIT(9)
...
static void tsc_step_config_adc(struct tscadc *ts_dev)
{
	...
	/* Step-13 for AIN4 */
	tscadc_writel(ts_dev, TSCADC_REG_STEPCONFIG(13), stepconfig | 
					TSCADC_STEPCONFIG_INP_SWC(4) |
					TSCADC_STEPCONFIG_INM_SWC_VREFN);
	tscadc_writel(ts_dev, TSCADC_REG_STEPDELAY(13), delay);
